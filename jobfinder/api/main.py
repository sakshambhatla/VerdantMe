...
from jobfinder.api.routes import analytics, companies, company_runs, job_runs, logs, me, motivation, pipeline, render_logs, resume, roles, settings, waitlist
...
app = FastAPI(title="JobFinder", version="5.8.1", lifespan=lifespan)
